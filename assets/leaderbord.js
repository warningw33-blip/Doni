function getProviderIcon(provider) {
  const icons = {
    'Pragmatic': 'https://yourcdn.com/icons/pragmatic.png',
    'PG Soft': 'https://yourcdn.com/icons/pgsoft.png',
    'Slot X PP': 'https://yourcdn.com/icons/slotxpp.png',
    'Habanero': 'https://yourcdn.com/icons/habanero.png',
    'Microgaming': 'https://yourcdn.com/icons/microgaming.png',
    'Spadegaming': 'https://yourcdn.com/icons/spadegaming.png',
    'JILI': 'https://yourcdn.com/icons/jili.png'
  };
...
const gamesByProvider = {
  ...
  'Slot X PP': [
    'Wukong - Black Samurai', 'Bang Gacor 1000', 'Slot88 Olympus 1000',
    'Slot88 Olympus', 'Jajanan Pasar', 'Starlight Princess 1000', 'Slot88 Sweet Bonanza',
    'Pirate Quest 1000', 'Slot88 Bonanza', 'Way of Ninja', 'Slot88 Princess',
    'Slot88 Gems', 'Slot88 Rush', 'Mighty Hercules', 'Thor vs Hercules'
  ],
  'Habanero': [
    'Hot Hot Nexus', 'Nexus Koi Gate', 'Nexus Wealth Inn', 'Mystic Fortune Nexus',
  ...
  'Microgaming': [
    'Lucky Twins Wilds', 'Lucky Twins Nexus', 'Nexus Mahjong Jackpot',
...
row.innerHTML = `
  ...
  <span>
    <img src="https://cdn-icons-png.flaticon.com/512/138/138281.png" width="18" style="vertical-align:middle; margin-right:4px;">
    ${formatRupiah(p.taruhan)}
  </span>
  <span class="menang">
    <img src="https://cdn-icons-png.flaticon.com/512/1041/1041875.png" width="18" style="vertical-align:middle; margin-right:4px;">
